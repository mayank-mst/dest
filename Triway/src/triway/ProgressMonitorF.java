...
import static triway.Home.jProgressBar2;
 
public class ProgressMonitorF extends JPanel {
    ...
    public static void main(String[] args) {        
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new ProgressMonitorF().createAndShowGUI();
            }
        });
    }
    ...
    class CopyFiles extends SwingWorker<List<CopyData>, CopyData> {
        ...
        public void process(List<CopyData> data) {
            ...
            if (update.getProgress() < 100 && !update.getisPaused()) {
                ...
                jProgressBar2.setValue((int) update.getProgress());
