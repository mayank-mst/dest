...
import static triway.Home.jProgressBar3;
 
public class ProgressMonitorG extends JPanel {
    ...
    public static void main(String[] args) {        
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new ProgressMonitorG().createAndShowGUI();
            }
        });
    }
    ...
    class CopyFiles extends SwingWorker<List<CopyData>, CopyData> {
        ...
        public void process(List<CopyData> data) {
            ...
            if (update.getProgress() < 100 && !update.getisPaused()) {
                ...
                jProgressBar3.setValue((int) update.getProgress());
